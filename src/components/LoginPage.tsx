...
export default function LoginPage() {
  ...
  return (
    <div className='border  w-[400px]  border-purple-300 py-2 rounded-xl flex flex-col items-center justify-center'>

  <div>

      <h2 className='text-3xl font-extrabold my-4'>Sign in with wallet</h2>

      <p className='text-sm text-red-600 text-center'>Recommended  :  use injected wallet</p>
